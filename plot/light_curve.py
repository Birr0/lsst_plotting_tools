...
from database.schemas import diasource, mpcorb, ssobjects
...
def _light_curve(
    ...
    '''
    Generates light curves for a given object from a dataframe or queries using an indentifier.
    ...
    Returns
    -------
    light_curve : ScatterPlot
        Returns the light curve as a scatter plot object.
